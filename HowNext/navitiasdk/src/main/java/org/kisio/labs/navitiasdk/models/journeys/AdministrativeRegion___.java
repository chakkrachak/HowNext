...
public class AdministrativeRegion___ {
    ...
    public Coord_______ getCoord() {
        return coord;
    }

    public void setCoord(Coord_______ coord) {
        this.coord = coord;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AdministrativeRegion___) == false) {
            return false;
        }
        AdministrativeRegion___ rhs = ((AdministrativeRegion___) other);
