...
public class AdministrativeRegion_____ {
    ...
    @Expose
    private Coord___________ coord;
    ...
    public Coord___________ getCoord() {
        return coord;
    }

    public void setCoord(Coord___________ coord) {
        this.coord = coord;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AdministrativeRegion_____) == false) {
            return false;
        }
        AdministrativeRegion_____ rhs = ((AdministrativeRegion_____) other);
