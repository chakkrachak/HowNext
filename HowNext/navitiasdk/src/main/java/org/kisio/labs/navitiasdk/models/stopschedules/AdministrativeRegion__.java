...
public class AdministrativeRegion__ {
    ...
    public Coord_____ getCoord() {
        return coord;
    }

    public void setCoord(Coord_____ coord) {
        this.coord = coord;
    }
    ...
    public boolean equals(Object other) {
        ...
        if ((other instanceof AdministrativeRegion__) == false) {
            return false;
        }
        AdministrativeRegion__ rhs = ((AdministrativeRegion__) other);
